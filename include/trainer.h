...
#include "pokemon.h"//trainers have a roster(array) of pokemon that they fight with, so they need to specifically know what a pokemon is.
...
public:
    ...
    // Purpose: Returns the name of the trainer
    std::string get_name();
