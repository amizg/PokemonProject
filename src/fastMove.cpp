...
#include <iostream>
#include "fastMove.h" // we need to know what class we're building
...
fastMove::fastMove(std::string Name, int bp, int ed, float cooldown, int Type, float duration){
